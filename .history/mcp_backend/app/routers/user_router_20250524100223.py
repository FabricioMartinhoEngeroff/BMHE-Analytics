...
# monta o UserService com settings
...
_user_service = UserService(
    ...
    whatsapp_service=WhatsAppService(
        ...
        from_number=_settings.TWILIO_WHATSAPP_FROM,
    ),
)
...
async def find_user_by_id(
    ...
    return await _user_service.find_user_by_id(db, user_id)
...
async def create_user(
    ...
    return await _user_service.create_user(db, dto)
...
async def update_user(
    ...
    return await _user_service.update_user(db, user_id, dto)
...
async def delete_user(
    ...
    await _user_service.delete_user(db, user_id)
    return None
