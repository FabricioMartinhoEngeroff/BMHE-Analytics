...
# Update the import path below if WhatsAppService is located elsewhere in your project structure
# Example: from mcp_backend.app.services.whatsapp_service import WhatsAppService
from mcp_backend.app.services.whatsapp_service import WhatsAppService  # <-- Fix the path if needed
