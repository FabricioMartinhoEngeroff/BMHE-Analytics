# mcp_backend/app/routers/auth_router.py
...
from mcp_backend.app.security.user_loader import get_current_user  # exemplo de dependência
...
def profile(current_user=Depends(get_current_user)):
    # get_current_user retorna um User carregado da session
